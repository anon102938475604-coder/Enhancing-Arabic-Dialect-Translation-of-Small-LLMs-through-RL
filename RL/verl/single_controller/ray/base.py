...
class RayWorkerGroup(WorkerGroup):
    ...
    def execute_all_async(self, method_name: str, *args, **kwargs):
        # Here we assume that if all parameters in args and kwargs are lists, and all list lengths match len(self._workers), we will send
        # each element in the list to the corresponding worker
